                            ...
                            <td>
                                <div class="action-buttons-group">
                                    <?php if ($estado === 'Activo'): ?>
                                        <form method="POST" action="/admin/accionUsuario" onsubmit="return confirm('¿Está seguro de bloquear a <?= $nombre_usuario ?>?');">
                                    ...
                                    <?php else: ?>
                                        <form method="POST" action="/admin/accionUsuario" onsubmit="return confirm('¿Está seguro de desbloquear a <?= $nombre_usuario ?>?');">
                                            <input type="hidden" name="id" value="<?= $id ?>">
                                    ...
                                    ?>
                                    <form method="POST" action="/admin/accionUsuario" onsubmit="return confirm('<?= $confirm_msg ?>');">
                                        <input type="hidden" name="id" value="<?= $id ?>">
                                    ...
                                    <form method="POST" action="/admin/accionUsuario" onsubmit="return confirm('ADVERTENCIA: ¿Está seguro de ELIMINAR permanentemente a <?= $nombre_usuario ?>? Esta acción es irreversible.');">
                                        <input type="hidden" name="id" value="<?= $id ?>">
