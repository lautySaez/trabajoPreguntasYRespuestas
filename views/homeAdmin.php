...
<div class="admin-wrapper">
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="index.php?controller=editor&method=gestionarPreguntas">
                <i class="fa fa-edit"></i> Gestión de Preguntas
            </a>
        </nav>
    ...
    <main class="content">
        ...
        <section class="kpi-grid">
            ...
            <div class="kpi-card">
                <span>Jugadores</span>
                <strong><?= htmlspecialchars($kpis['total_usuarios'] ?? '—') ?></strong>
            </div>
            <div class="kpi-card">
                <span>Partidas</span>
