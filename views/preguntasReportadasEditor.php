...
?>
    ...
    <div class="reportes-page">
        ...
        <div class="tabs-reportes">
            <a href="/editor/preguntasReportadas?filtro_estado=Activo"
               class="tab <?= ($filtro_estado === 'Activo' ? 'active' : '') ?>">
                Activos
            </a>
            <a href="/editor/preguntasReportadas?filtro_estado=Resuelto"
        ...
        <?php if ($pregunta_id && $pregunta_info): ?>
            <div class="reportes-detalle-container">
                ...
                <div class="acciones-detalle">
                    <a href="/editor/gestionarPreguntas?filtro_reportes=reportadas&buscar_id=<?= $pregunta_id ?>"
                       class="btn-gestionar">
                    ...
                    <a href="/editor/preguntasReportadas" class="btn-volver">
                    ...
                    <table class="tabla-reportes">
                        ...
                        <?php foreach ($reportes_agrupados as $reporte): ?>
                            <tr class="reporte-row">
                                ...
                                <td class="acciones">
                                    <a href="/editor/preguntasReportadas?id=<?= $reporte['pregunta_id'] ?>" class="btn-detalles">
                                        <i class="fa-solid fa-eye"></i> Ver Detalles
                                    </a>
                                    <a href="/editor/gestionarPreguntas?filtro_reportes=reportadas&buscar_id=<?= $reporte['pregunta_id'] ?>"
    ...
    <div id="modalResolucion" class="modal">
        <div class="modal-content">
            ...
            <form id="formResolucion" method="post" action="/editor/resolverReporte">
